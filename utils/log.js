...
const debug = function (msg, tips) {
  if (isBoolean(tips) && tips) console.log(chalk`{black.bgCyan  DEBUG } {cyanBright ${msg}}`)
...
const sucess = function (msg, tips) {
  if (isBoolean(tips) && tips) console.log(chalk`{black.bgGreen  SUCESS } {greenBright ${msg}}`)
...
const info = function (msg, tips) {
  if (isBoolean(tips) && tips) console.log(chalk`{black.bgBlue  INFO } {blueBright ${msg}}`)
...
const error = function (msg, tips) {
  if (isBoolean(tips) && tips) console.log(chalk`{black.bgRed  ERROR } {redBright ${msg}}`)
...
const warn = function (msg, tips) {
  if (isBoolean(tips) && tips) console.log(`${chalk.black.bgKeyword('orange')(' WARN ')} ${chalk.keyword('orange')(msg)}`)
